...
document.addEventListener('DOMContentLoaded', () => {
  ...
  async function initRecentWorks() {
    ...
    videoData.forEach(item => {
      ...
      // On mobile, use a clickable thumbnail instead of iframe
      let playerHTML;
      if (isMock) {
        playerHTML = `<video class="recent-video-player" muted loop playsinline poster="${thumb}" style="width: 100%; height: 100%; object-fit: cover;">
